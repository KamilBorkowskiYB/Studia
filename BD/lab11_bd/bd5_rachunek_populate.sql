...
Insert into BD5_KLIENT(NR_KLIENTA,KLIENT_NAZWISKO,KLIENT_IMIE,KLIENT_ADRES,KLIENT_MIASTO,KLIENT_KOD_ADRESOWY) values (2,'Nowak','Adam','ul. Kwiatowa 12 / 5','Kraków','31-879');

Insert into BD5_KLIENT(NR_KLIENTA,KLIENT_NAZWISKO,KLIENT_IMIE,KLIENT_ADRES,KLIENT_MIASTO,KLIENT_KOD_ADRESOWY) values (3,'Boczyñski','Edward','ul. Spokojna 56','Warszawa','01-237');

Insert into BD5_KLIENT(NR_KLIENTA,KLIENT_NAZWISKO,KLIENT_IMIE,KLIENT_ADRES,KLIENT_MIASTO,KLIENT_KOD_ADRESOWY) values (4,'Walecki','Franciszek','ul. S³oneczna 4 / 6','Kraków','31-769');

Insert into BD5_KLIENT(NR_KLIENTA,KLIENT_NAZWISKO,KLIENT_IMIE,KLIENT_ADRES,KLIENT_MIASTO,KLIENT_KOD_ADRESOWY) values (5,'Misiowiec','Jacek','pl. Miejski 14','£ódŸ','90-019');
...
Insert into BD5_KLIENT(NR_KLIENTA,KLIENT_NAZWISKO,KLIENT_IMIE,KLIENT_ADRES,KLIENT_MIASTO,KLIENT_KOD_ADRESOWY) values (7,'Polewski','Zbigniew','ul. Zgody 17 / 16','£ódŸ','90-019');
...
Insert into BD5_PRODUKT(NR_PRODUKTU,NAZWA_PRODUKTU,CENA_PRODUKTU,ROK_PRODUKCJI,RANKING) values (5,'Spódnica',80,2019,3);
...
Insert into BD5_PRODUKT(NR_PRODUKTU,NAZWA_PRODUKTU,CENA_PRODUKTU,ROK_PRODUKCJI,RANKING) values (9,'Buty mêskie',110,2019,4);
