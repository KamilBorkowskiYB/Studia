...
/*                                                       */
/* Nale¿y wykonywaæ fragmenty skryptu krokowo            */
/* i obserwowaæ tworzenie siê nowych obiektów po ka¿dym  */
...
/* kolumna STATUS_WYPOZYCZENIA przyjmuje wartoœci:
   WYP - ksi¹¿ka jest wypo¿yczona,
   ZWR - ksi¹¿ka zwrócona o czasie,
   POT - ksi¹¿ka zwrócona po terminie
*/
...
values
	(1,'Szewczyk','Katarzyna','ul. Kwitn¹ca 15','£ódŸ','12-456','1989/02/23');
...
--Odczytaæ zawartoœæ tabel
--Ponownie wprowadziæ dane do tabel
--Odczytaæ zawartoœæ tabel
